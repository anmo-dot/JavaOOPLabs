...
public class TicketingClerk {
	...
	protected static String currentDate = "7/3";
			...
			case 2:
				...
				if(lst.containsKey(ticket)) {
					...
					case 'O':
						...
						break;
					case 'R':
						ReturnTicket ret = new ReturnTicket(t);
						System.out.print("\n=================================");
						System.out.println("\nTicket Options: ");
						...
						case 1:
							...
							String go = s.next();
							ret.onward(currentDate, go);
							break;
						case 2:
							System.out.println("Return Date: ");
							String back = s.next();
							ret.returning(currentDate, back);
							break;
						}
						break;
					case 'M':
						MutliUseTicket multi = new MutliUseTicket(t);
					default:
