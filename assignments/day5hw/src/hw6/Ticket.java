...
public class Ticket {
	...
	public Ticket(String issueDay, String origin, String destination, int remainingTrips, char type) {
		this();
		this.issueDay = issueDay;
		this.origin = origin;
		this.destination = destination;
	...
	public Ticket(String issueDay, String origin, String destination, char type) {
		this();
		this.issueDay = issueDay;
		this.origin = origin;
		this.destination = destination;
